...
const items: PortfolioItem[] = [
  ...
  // },
  {
    title: 'Booky',
    description:
      'Booky is a modern library web app built with React, TypeScript, and Vite. It features authentication, book search and filters, detailed pages with reviews and stock, loan management, and user profiles. Styling uses Tailwind CSS + shadcn/ui, with Redux Toolkit, TanStack Query, and Day.js. Use the following dummy account to log in and explore the features => Email: johndoe@example.com Password: 123456',
    image: portfolio3,
  ...
  },
  {
    title: 'Foody',
    description:
      'Foody is a restaurant web app built with React, Vite, and TypeScript. It enables users to explore menus, apply filters, search dishes, manage their cart, and complete simple checkouts. Styled with Tailwind CSS and shadcn/ui, it uses Redux Toolkit for UI state and TanStack Query for server data, responsive, and structured user experiences. Use the following dummy account to log in and explore the features => Email: johndoe@example.com Password: johndoe123',
    image: portfolio4,
